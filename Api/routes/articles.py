...
def format_article(doc: dict) -> dict:
    ...
    doc["_id"] = str(doc["_id"])
    doc["a_audio"] = bool(doc.get("audio_moore_path") or doc.get("audio_fr_path"))
    doc["a_moore"] = bool(doc.get("traduction_moore"))
    return doc


@router.get("/", response_model=List[ArticleResume])
